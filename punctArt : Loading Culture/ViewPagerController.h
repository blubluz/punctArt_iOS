 ...
 * ViewPagerOptionTabFixedWidth: 1.0: YES, 0.0: NO, defaults to YES , defines if the tabs should have the fixed width from ViewPagerOptionTabWidth, or if the width should change with views content .
 */
typedef NS_ENUM(NSUInteger, ViewPagerOption) {
    ViewPagerOptionTabHeight,
    ViewPagerOptionTabFixedWidth,
